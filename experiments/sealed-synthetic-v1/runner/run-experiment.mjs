...
import { renderExperimentReport } from "../reports/render-report.mjs";
...
try {
  ...
  writeFileSync(resolve(runDirectory, "run-summary.json"), `${JSON.stringify({ runId, reportHash: finalized.reportHash, truthHash: revealed.truthHash, sessions: completed.sessions, publicMetadata: ready.publicMetadata }, null, 2)}\n`, "utf8");
